...
# Verify version
akios --version
# Should show: akios 1.0.3 or later
...
# Test run
docker run --rm akiosai/akios:v1.0.3 --version
```
...
# Update wrapper
curl -O https://raw.githubusercontent.com/akios-ai/akios/v0.9.5/akios
```
