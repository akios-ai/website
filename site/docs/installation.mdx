...
- Choose your AI provider (OpenAI, Anthropic, Grok, Mistral, Gemini, AWS Bedrock, or Ollama)
- Add your API key securely (or configure IAM for Bedrock, or skip for Ollama local models)
- Set budget limits
...
- [AWS Bedrock](https://aws.amazon.com/bedrock/) - Claude, Llama, Titan (IAM auth, no API key needed)
- [Ollama](https://ollama.com/) - Llama, Mistral, Gemma (free local models, no API key needed)
