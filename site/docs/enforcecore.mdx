...
> **Current release: v1.0.0b3 (beta)** — Frozen 30-symbol API, 1,503+ tests, 22 formal invariants. See the [full EnforceCore documentation](/enforcecore/) for complete details.
