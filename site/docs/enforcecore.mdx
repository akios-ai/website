...
> **Current release: v1.0.1 (stable)** — Frozen 30-symbol API, 1,510 tests, 22 formal invariants. See the [full EnforceCore documentation](/enforcecore/) for complete details.
