...
> **Current version: {{version}}.** Rich terminal UI, environment auto-detection, accessibility modes, workflow validation, 53 PII patterns, Merkle audit proofs, and ablation benchmarking.
