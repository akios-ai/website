...
steps:                           # Required: List of steps
  - name: "Step 1"              # Required: Step name
    ...
    action: "generate"          # Required: What action
...
|-------|---------|----------------|
| **llm** | AI model calls | `generate`, `chat`, `complete` |
| **http** | Web/API requests | `request` (GET, POST, PUT, DELETE) |
...
**Actions:**
- `request` - Make HTTP request (specify method in parameters)
