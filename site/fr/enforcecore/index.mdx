...
<div style="text-align: center; margin-bottom: 2rem;">
  <img class="ec-logo-light" src="../../assets/img/logo-enforcecore-light.svg" alt="Logo EnforceCore" style="max-width: 180px; height: auto;" />
  <img class="ec-logo-dark" src="../../assets/img/logo-enforcecore-dark.svg" alt="Logo EnforceCore" style="max-width: 180px; height: auto;" />
</div>
...
> **Version actuelle : v1.0.1 (stable)** — Première version stable, API de production, 1 510 tests, 22 invariants formels. [Disponible sur PyPI](https://pypi.org/project/enforcecore/).
