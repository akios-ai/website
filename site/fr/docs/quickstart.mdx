...
**Activer la cage de sécurité :**
```bash
akios cage up
akios cage status
```

**Analyser les fichiers pour les PII avant traitement :**
```bash
...
**Voir la chronologie d'exécution :**
```bash
akios timeline
```
...
- **[Sécurité](security)** — cage, sandbox, rédaction PII, chaîne d'audit.
