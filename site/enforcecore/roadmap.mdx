...
EnforceCore is in **beta** at v1.0.0b3. The 30-symbol Tier 1 API is frozen. All 110 original symbols remain importable for backwards compatibility.

```bash
pip install enforcecore==1.0.0b3
```
