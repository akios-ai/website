...
> **Current release: v1.0.1 (stable)** — Production-ready, first stable API, 1,510 tests, 22 formal invariants. [Available on PyPI](https://pypi.org/project/enforcecore/).
...
- **1,510 tests**, 95% coverage, 22 formal invariants ([Hypothesis](https://hypothesis.readthedocs.io/) property-based testing)
