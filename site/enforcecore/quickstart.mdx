...
> **Note:** EnforceCore is **stable** at v1.14.0. The 63-symbol public API is stable and follows semver.
...
- [API Reference →](api-reference.html) — Complete API surface (63 public symbols)
