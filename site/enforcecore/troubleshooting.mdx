...
Yes. EnforceCore is in **beta** (v1.0.0b3) with 1,503+ tests, 95% coverage, 22 formal invariants, and a frozen 30-symbol API. "Beta" means the API contract is stable and actively hardened — it has not yet been promoted to GA because we are accumulating production deployment feedback.
