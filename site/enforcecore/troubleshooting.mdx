...
5 categories: email, phone, SSN, credit card, IP address. 4 redaction strategies: placeholder, mask, hash, remove. See the [API Reference](/enforcecore/api-reference#redactor-api) for the full table.
