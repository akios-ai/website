...
These invariants are verified *empirically* (high confidence from thousands of random inputs), not *mechanically proved* via theorem provers. See the [formal invariants document](https://github.com/akios-ai/EnforceCore/blob/main/docs/formal/invariants.md) for the full specification with formal notation.
