...
<div class="post-content">
  <p class="lead">
    AKIOS v1.0 is the security cage you've been waiting for. Run AI agents with confidence — they can't leak data, burn budgets, or escape their sandbox. Everything is auditable, provable, and production-ready.
  </p>

  <p>
    This isn't a general-purpose AI framework. It's <strong>the unbreakable cage</strong>: kernel-level isolation, real-time PII redaction, tamper-proof audit trails, and enforced budget controls.
  </p>
...
akios templates   # List available templates</code></pre>
  ...
  <h3>🐍 Pip Package (Recommended for Most Users)</h3>
  <p><strong>Best for:</strong> Python developers, CI/CD pipelines, quick testing</p>
  <pre><code>pip install akios
akios init my-project
cd my-project
akios run templates/hello-workflow.yml</code></pre>

  <h3>📦 Standalone Binary (No Python Required)</h3>
  <p><strong>Best for:</strong> Production servers, air-gapped environments, maximum control</p>
  <pre><code># Download from github.com/akios-ai/akios/releases
chmod +x akios-linux-x64
./akios-linux-x64 init my-project</code></pre>

  <h3>🐳 Docker (Cross-Platform Teams)</h3>
  <p><strong>Best for:</strong> macOS/Windows development, consistent environments</p>
